<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Fusion/Views/Shared/Site.Master"
	Inherits="System.Web.Mvc.ViewPage<Atom.Main.Areas.Fusion.Models.ViewModels.ProjectCompleteViewModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Atom Fusion --> Complete Project
	<%=Model.Project.Id %>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div class="case-details">
		<div class="container_16">
			...
			<div class="grid_12">
				...
				<span class="case-raised">Raised by:
					...
					<%=Model.Project.CreateDate.Value.FormatDateTimeRelative()%></span> <span class="case-updated">
						Last updated:
						<%=Model.Project.AlteredDate.FormatDateTimeRelative()%></span>
			</div>
			<div class="clear">
			</div>
		</div>
		<div class="container_16">
			...
			<div class="grid_12">
				<%Html.RenderPartial("ProjectCompletion"); %>
			</div>
			<div class="clear">
			</div>
</asp:Content>
